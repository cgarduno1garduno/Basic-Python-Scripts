...
# 	emails, then print list of emails & how many emails were found
...
# 	sent from a single person using a dictionary to keep track of senders and number
#	of emails sent. Iterate through dictionary to find greates value
